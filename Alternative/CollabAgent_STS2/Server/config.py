...
# --- combat setup ----------------------------------------------------
# Type ids, not classes. Session resolves these through unit_registry at
# spawn time — if a type_id here was never registered, spawning fails
# loudly instead of silently succeeding through a direct import.
ALLY_TYPE_ID = "testally1"
ENEMY_TYPE_IDS = ("dummy1",)

# Fails immediately on startup (not on first player join) if either id
# above was never registered.
