...
from entities import Player, HAND_LIMIT
import enemies as E
...
for fname in ("cards.py", "relics.py", "potions.py", "enemies.py", "combat.py"):
    src = _io.open(os.path.join(ROOT, fname), encoding="utf-8").read()
...
src = _io.open(os.path.join(ROOT, "entities.py"), encoding="utf-8").read()
